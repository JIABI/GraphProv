...
def parameter_parser():
    ...
    parser.add_argument("--input",
                        nargs="?",
                        default="D:/GEMSEC-master/data/flights_edges.csv",
	                help="Input graph path.")

    parser.add_argument("--embedding-output",
                        nargs="?",
                        default="D:/GEMSEC-master/output/embeddings/flight_embedding.csv",
	                help="Embeddings path.")

    parser.add_argument("--cluster-mean-output",
                        nargs="?",
                        default="D:/GEMSEC-master/output/cluster_means/flight_means.csv",
	                help="Cluster means path.")

    parser.add_argument("--log-output",
                        nargs="?",
                        default="D:/GEMSEC-master/output/logs/flight.json",
	                help="Log path.")

    parser.add_argument("--assignment-output",
                        nargs="?",
                        default="D:/GEMSEC-master/output/assignments/flight.json",
	                help="Log path.")
    ...
    parser.add_argument("--walker",
                        nargs="?",
                        default="first",
	                help="Random wal ker order. Default is first.")
    ...
    parser.add_argument("--cluster-number",
                        type=int,
                        default=628,
	                help="Number of clusters. Default is 180.")
